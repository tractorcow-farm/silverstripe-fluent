...
summary: Configuring Fluent to associate different domain names with specific locales
icon: server
---
...
their [LocaleMenu](./09_templating.md).
...
- Set the [`FluentDirectorExtension.force_domain`](api:TractorCow\Fluent\Extension\FluentDirectorExtension->force_domain) config to true.
...
need to alter your project's configuration between environments.
